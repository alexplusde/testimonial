...
/*
$modules = scandir(rex_path::addon("testimonial")."module");

foreach ($modules as $module) {
    if ($module == "." || $module == "..") {
        continue;
    }
    $module_array = json_decode(rex_file::get(rex_path::addon("testimonial")."module/".$module), 1);
    ...
    ->setValue("createuser", "")
    ->setValue("updateuser", "testimonial")
